...
inline std::unique_ptr<juce::InputStream> createAssetInputStream (const char* resourcePath)
{
    ...
    assetsDir = juce::File ("/Users/andy/Desktop/Programming/Projects/Concurrencpp-Gui");
...
//==============================================================================
 ...
 inline juce::CodeEditorComponent::ColourScheme getDarkCodeEditorColourScheme()
 {
     struct Type
     {
         const char* name;
 ...
 inline juce::CodeEditorComponent::ColourScheme getLightCodeEditorColourScheme()
 {
     struct Type
     {
         const char* name;
